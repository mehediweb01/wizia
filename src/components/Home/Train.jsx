...
const Train = () => {
  ...
  return (
    <section className="bg-[url(/train-bg.png)] bg-no-repeat bg-cover sm:mx-12 mx-8 sm:py-28 py-8 ">
      <div className="flex justify-center items-center">
        <div className="lg:ps-60 md:ps-40 sm:ps-20 ps-6">
          ...
          <div className="sm:pt-[30px] pt-5 sm:pb-16 pb-10">
            <p className="text-secondary  font-workSans font-[300] sm:text-2xl text-[18px] sm:leading-[31px] leading-[23px] -tracking-[1%] max-w-md">
          ...
          <div className="grid sm:grid-cols-2 grid-cols-1 gap-3">
            {list.map((item, index) => (
              <div key={index} className="flex items-center gap-1">
                ...
                <p className="text-cyan font-Montserrat font-[500] sm:text-[20px] text-base sm:leading-[26px] leading-5 -tracking-[1%]">
                  {item.title}
                </p>
              </div>
            ))}
